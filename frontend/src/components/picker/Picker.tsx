  ...
  return (
    ...
    >
      ...
      <div style={highlightStyle}>
        <div className="absolute bottom-auto left-0 right-auto top-0 h-px w-full scale-y-50 bg-black/45 dark:bg-white/45" />
        <div className="absolute bottom-0 left-0 right-auto top-auto h-px w-full scale-y-50 bg-black/45 dark:bg-white/45" />
      </div>
    </div>
  );
}
